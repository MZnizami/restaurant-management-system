...
@FXML
    ...
    @FXML
    private Button addAttendence2;

    @FXML
    private Tooltip waiterAttendence;

    @FXML
    private Button addWaiter2;

    @FXML
    private Tooltip AddWaiter;
    ...
    @FXML
    private JFXButton addAttendence;

    @FXML
    private JFXButton addTasks;

    @FXML
    private JFXButton addWaiter;;
     
        @FXML
    void addAttendence(ActionEvent event) throws IOException {
      Parent root;
            
             root= FXMLLoader.load(getClass().getResource("addAttendenceAdmin.fxml"));
              Stage s= new Stage();
 ...
 Parent root;
             ...
             root= FXMLLoader.load(getClass().getResource("addTasksAdmin.fxml"));
              Stage s= new Stage();
              Scene scene = new Scene(root);
               s.setScene(scene);
                s.show();
    ...
    @FXML
    void addWaiter(ActionEvent event) throws IOException {
 Parent root;
            
             root= FXMLLoader.load(getClass().getResource("addWaiterAdmin.fxml"));
              Stage s= new Stage();
              Scene scene = new Scene(root);
               s.setScene(scene);
                s.show();
...
/////////when clicked the admin will go the Menu controller the Main page will get closed and the Menu controller page will appear 
   ...
   root= FXMLLoader.load(getClass().getResource("addMenu.fxml"));
              Stage s= new Stage();
              Scene scene = new Scene(root);
              s.setTitle("                Admin Menu Controller");
               s.setScene(scene);
                s.show();
...
////////when clicked the Admin will go the the reservation page where she checks the reservation table of customers 
  ...
  Parent root;
   root= FXMLLoader.load(getClass().getResource("reservation.fxml"));
              Stage s= new Stage();
              Scene scene = new Scene(root);
              s.setTitle("                Admin Reservation Controller");
               s.setScene(scene);
                s.show();
...
//////when clicked the Admin will go the Raw Material page where she adds/Deletes/Update the data inside the table
  ...
  Parent root;
   root= FXMLLoader.load(getClass().getResource("Items.fxml"));
              Stage s= new Stage();
              Scene scene = new Scene(root);
               s.setTitle("               Raw Materials Admin Controller");
               s.setScene(scene);
                s.show();
